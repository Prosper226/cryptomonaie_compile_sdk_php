...
// print_r($intouch->deposit('ORANGE', ["phonenumber" => 57474578, "amount" => 100, "txId" => "TEST-DEPOT-230304-007", "otp" => 581964]));
// print_r($intouch->deposit('MOOV', ["phonenumber" => 72287800, "amount" => 500, "txId" => "TEST-DEPOT-230304-009"]));
// print_r($intouch->deposit('MOOV', ["phonenumber" => 60565103, "amount" => 500, "txId" => "TEST-DEPOT-230304-010"]));
// print_r($intouch->deposit('AIRTEL', ["phonenumber" => '074772549', "amount" => 100, "txId" => "TEST-DEPOT-230304-001"]));
